...
import one.stk.com.indextextview.R;
...
public class IndexView extends TextView {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        SetIndex(newSelectIndex, tipVisible);
        return true;
    }
     ...
     * 切换右边字幕位置
     */
    public void SetIndex(int newSelectIndex, boolean tipVisible) {
        ...
        if (selectIndex != newSelectIndex && onIndexChangeListener != null) {
            Log.e("ttt", "跳转字幕" + String.valueOf(INDEXES.charAt(newSelectIndex)) + "----" + tipVisible + "----" + newSelectIndex);
            onIndexChangeListener.OnIndexChange(newSelectIndex, INDEXES.charAt(newSelectIndex));
